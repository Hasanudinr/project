...
<html lang="en">
  ...
  <body>
    ...
    <main class="mt-5 pt-3">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <h4>Kegiatan Pendidikan Anak</h4>
          </div>
        </div>
        <!-- pendidikan -->
        <div class="row">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/Pendidikan/formal4.jpeg" class="d-block w-100" alt="...">
    ...
    <div class="carousel-item">
      <img src="img/Pendidikan/formal2.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
    ...
    <div class="carousel-item">
      <img src="img/Pendidikan/formal3.jpeg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/Pendidikan/non1.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>First slide label</h5>
    ...
    <div class="carousel-item">
      <img src="img/Pendidikan/non2.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>Second slide label</h5>
        <p>Some representative placeholder content for the second slide.</p>
      </div>
    ...
    <div class="carousel-item">
      <img src="img/Pendidikan/non3.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>Third slide label</h5>
        <p>Some representative placeholder content for the third slide.</p>
      </div>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/Pendidikan/pramuka1.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>First slide label</h5>
        <p>Some representative placeholder content for the first slide.</p>
      </div>
    ...
    <div class="carousel-item">
      <img src="img/Pendidikan/pramuka2.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>Second slide label</h5>
        <p>Some representative placeholder content for the second slide.</p>
      </div>
    ...
    <div class="carousel-item">
      <img src="img/Pendidikan/pramuka3.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>Third slide label</h5>
        <p>Some representative placeholder content for the third slide.</p>
      </div>
